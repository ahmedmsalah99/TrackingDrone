...
namespace ocsort {
    ...
    public:
        ...
        void predict();
        void update(std::shared_ptr<Eigen::VectorXf> z_);
        void freeze();
        void unfreeze();
    ...
    public:
        ...
        std::vector<std::shared_ptr<Eigen::VectorXf>> history_obs;
        ...
        bool observed = false;
        std::vector<std::shared_ptr<Eigen::VectorXf>> new_history; // Used to create a virtual trajectory.
